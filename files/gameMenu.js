        ...
        windowAboutGame.style.top = 50*adaptationIndex + 'px';
        ...
        textOption.innerHTML = 'Music  ';
        windowOption.appendChild(textOption);

        var textOption = windowOption.getElementsByClassName('textOption')[0];
        textOption.style.marginLeft = 115*adaptationIndex + 'px';
        ...
        windowOption.appendChild(checkboxOption);          

        var checkboxOption = windowOption.getElementsByClassName('checkboxOption')[0];  
        ...
        buttonCloseOption.style.marginTop = '75%';
